...
#### [What is fast-tracking in project management?](https://www.wrike.com/project-management-guide/faq/what-is-fast-tracking-in-project-management/)
...
> To use fast-tracking in project management, you must first go over the critical path and identify which tasks can be performed parallel to one another. <br>
...
#### [What are the risks of fast-tracking in project management?](https://www.wrike.com/project-management-guide/faq/what-is-fast-tracking-in-project-management/)

> As the PMBOK Guide points out, “fast-tracking may result in rework and increased risk.” For instance, the project may become more difficult to control because of increased complexity. The overall quality and efficiency of the work may also suffer due to tasks beginning in the middle of other tasks. <br>
...
## [Waterfall](https://library.superhi.com/posts/5-essential-project-management-methodologies-you-need-to-know)

> There are generally two broad approaches to project management: Waterfall and Lean. Waterfall feels like an assembly line, where one thing happens after another, in sequence. <br>
> It first originated in the 1950s and is based on traditional construction and manufacturing industry processes. Waterfall doesn’t stray from the plan, aims to document and scope everything from the start. <br>
...
#### [What is the Waterfall methodology? ](https://www.workfront.com/project-management/methodologies/waterfall)

> The Waterfall methodology—also known as the Waterfall model—is a sequential development process that flows like a waterfall through all phases of a project (analysis, design, development, and testing, for example), with each phase completely wrapping up before the next phase begins. <br>
...
#### [What is Agile project management?](https://www.workfront.com/project-management/methodologies/agile)

> Agile project management is an iterative approach to project management that focuses on breaking down large projects into more manageable tasks, which are completed in short iterations throughout the project life cycle. Teams that adopt the Agile methodology are able to complete work faster, adapt to changing project requirements, and optimize their workflow. <br>
...
#### [What is Scrum?](https://library.superhi.com/posts/5-essential-project-management-methodologies-you-need-to-know)

> Scrum is a sub-category of Agile that breaks down the process more specifically. So agile is the broad umbrella focused on iteration, flexibility and collaboration, and scrum gets more specific with how that gets done. <br>
> Within scrum, there are sprints. <br>
> A sprint is a pre-defined chunk of time - often ranging anywhere from one-week to a month, but can be as short as a 1 day sprint too. At the start of a sprint, the team will hold a sprint planning meeting to prioritize the sprint’s tasks. <br>
...
In _[Agile principles](https://en.wikipedia.org/wiki/Agile_software_development#Agile_principles "Agile software development")_, **timeboxing** allocates a fixed and maximum unit of time to an activity, called a **timeboxing**, within which planned activity takes place. It is used by _Agile principles_-based [project management](https://en.wikipedia.org/wiki/Project_management "Project management") approaches and for personal time management.

![image](https://thedigitalprojectmanager.com/wp-content/uploads/2021/08/9-Popular-Project-Management-Methodologies.png)
